...
Note: OCI creates default root compartment during account/tenant creation. It should be not be used for this project. Recommendation is to have a new compartment or a child compartment.
