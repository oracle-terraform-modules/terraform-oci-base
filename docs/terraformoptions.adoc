...
|Whether to upgrade the instance on first boot. If you choose Ubuntu for the bastion and you set this to true, also set the bastion_package_update to true as well.
|true/false
|true
